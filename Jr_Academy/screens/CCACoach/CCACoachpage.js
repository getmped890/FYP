...
import CCASettingScreen from './Settings/CCASetting';
...
import CCAAttendanceRecordScreen from './Attendance/CCAAttendanceRecord';
...
function StackNavigator(){
  return(
    ...
    >
      ...
      <Stack.Screen name="CCAAttendanceRecord" component={CCAAttendanceRecordScreen} />
...
function StackSettingNavigator(){
  return(
    ...
    >
      <Stack.Screen name="CCASetting" component={CCASettingScreen} />
